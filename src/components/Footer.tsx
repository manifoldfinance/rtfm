...
function DiscourseIcon(props: React.ComponentPropsWithoutRef<'svg'>) {
  return (
  ...
  return (
    <div className="flex flex-col items-center justify-between gap-5 border-t border-zinc-900/5 pt-8 dark:border-white/5 sm:flex-row">
      <p className="text-xs text-zinc-600 dark:text-zinc-400">
        &copy; Copyright {new Date().getFullYear()}. CommodityStream, Inc. All rights reserved.
      </p>
      <div className="flex gap-4">
        <SocialLink href="https://twitter.com/foldfinance" icon={TwitterIcon}>
          Follow us on Twitter
        </SocialLink>
        <SocialLink href="https://github.com/manifoldfinance" icon={GitHubIcon}>
          Follow us on GitHub
        </SocialLink>
        <SocialLink href="https://forums.manifoldfinance.com" icon={DiscourseIcon}>
          Join our Discourse forums
        </SocialLink>
      </div>
    </div>
  );
