...
After picking your preferred client, you are ready to make your first call to the Protocol API. Below, you can see how to send a GET request to the Modules endpoint to get a list of all your conversations. In the cURL example, results are limited to ten conversations, the default page length for each client.
...
<div className="not-prose">
  <Button
    ...
    variant="text"
    arrow="right"
    children="Read the docs for the Modules endpoint"
  />
</div>
