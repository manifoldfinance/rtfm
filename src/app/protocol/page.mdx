...
<Properties>
  ...
  <Property name="INDETERMINATE">
    A INDETERMINATE status code indicates Services received correctly the Tx && at
  ...
  <Property name="ERROR">
    A ERROR status code indicates that the services haven't received the TX || none
