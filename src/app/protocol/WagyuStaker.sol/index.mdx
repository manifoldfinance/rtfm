...
_This contract stakes Ether inside of the BeaconChainDepositContract directly_
...
_Only callable by an operator. Additionally, if there is an issue when granting rewards to the MevEth contract, funds are secured to the
beneficiary address for manual allocation to the MevEth contract._
