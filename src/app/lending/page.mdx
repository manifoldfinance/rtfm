...
<Row>
  ...
  <Col sticky>
    ...
    ```bash {{ title: 'cURL' }}
    curl https://docs.meveth.org/v1/conversations/xgQQXg3hrtjh7AvZ \
      -H "Authorization: Bearer {token}"
    ```
...
<Row>
  ...
  <Col sticky>
    ...
    ```bash {{ title: 'cURL' }}
    curl -X PUT https://docs.meveth.org/v1/conversations/xgQQXg3hrtjh7AvZ \
      -H "Authorization: Bearer {token}" \
      -d 'is_muted'=true
    ```
...
<Row>
  ...
  <Col sticky>
    ...
    ```bash {{ title: 'cURL' }}
    curl -X DELETE https://docs.meveth.org/v1/conversations/xgQQXg3hrtjh7AvZ \
      -H "Authorization: Bearer {token}"
    ```
