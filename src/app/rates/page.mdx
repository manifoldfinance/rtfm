...
<Row>
  ...
  <Col sticky>
    ...
    ```bash {{ title: 'cURL' }}
    curl -G https://docs.meveth.org/v1/groups \
...
<Row>
  ...
  <Col sticky>
    ...
    ```bash {{ title: 'cURL' }}
    curl https://docs.meveth.org/v1/groups \
      -H "Authorization: Bearer {token}" \
      -d name="Plaza Hotel"
    ```
...
<Row>
  ...
  <Col sticky>
    ...
    ```bash {{ title: 'cURL' }}
    curl https://docs.meveth.org/v1/groups/L7cGNIBKZiNJ6wqF \
      -H "Authorization: Bearer {token}"
    ```
...
<Row>
  ...
  <Col sticky>
    ...
    ```bash {{ title: 'cURL' }}
    curl -X PUT https://docs.meveth.org/v1/groups/L7cGNIBKZiNJ6wqF \
      -H "Authorization: Bearer {token}" \
...
<Row>
  ...
  <Col sticky>
    ...
    ```bash {{ title: 'cURL' }}
    curl -X DELETE https://docs.meveth.org/v1/groups/L7cGNIBKZiNJ6wqF \
      -H "Authorization: Bearer {token}"
    ```
